local utils = require("highlight-colors.utils")
local table_utils = require("highlight-colors.table_utils")
local buffer_utils = require("highlight-colors.buffer_utils")
local colors = require("highlight-colors.color.utils")
local color_patterns = require("highlight-colors.color.patterns")
local ns_id = vim.api.nvim_create_namespace("highlight-colors")

if vim.g.loaded_highlight_colors ~= nil then
	return {}
end
vim.g.loaded_highlight_colors = 1
...
---...other configs
---formatting = {
---    format = require("highlight-colors").format
---}
